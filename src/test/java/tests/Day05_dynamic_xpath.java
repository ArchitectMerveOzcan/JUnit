...
public class Day05_dynamic_xpath {
    ...
    public void dynamicXpath() {
        ...
        WebElement userNameText = this.driver.findElement(By.xpath("//*[.='Username : Admin']"));
        Assert.assertTrue(userNameText.isDisplayed());
        //Verify if "Password : admin123" text is displayed on the page
        WebElement passwordText = this.driver.findElement(By.xpath("//*[.='Password : admin123']"));
        Assert.assertTrue(userNameText.isDisplayed());
        ...
        WebElement passwordText1 = this.driver.findElement(By.xpath("//*[contains(text(),'Passw')]"));
