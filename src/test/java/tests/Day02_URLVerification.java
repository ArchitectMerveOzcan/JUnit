...
public class Day02_URLVerification {
    public static void main(String[] args) {
        ...
        -Then I do my manual testing FIRST
            ...
            -If I find a bug/defect, then I talk to dev. Dev fixed the issue, then I retest. If all is good then start my automation script.
...
------------------------------------------------------
        ...
        -Retest to make sure from the failure. It can be data issue, typo, documentation or is can be a real bug.
